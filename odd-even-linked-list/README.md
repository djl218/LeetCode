[<h2>Click here for detailed solution<h2>](https://www.danielleskosky.com/odd-even-linked-list/)
...
<p>&nbsp;</p>
<strong>Follow up:</strong> Could you solve it in <code>O(1)</code> space complexity and <code>O(nodes)</code> time complexity?</div>
